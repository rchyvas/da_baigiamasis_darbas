...
# analizei reikalingų duomenų pasiėmimas iš lokalios duomenų bazės
...
# duomenų pasiruošimas skritulinės diagramos braižymui
...
# susirgimų top ligomis istorija kreivemis viename grafike per visa laikotarpį
...
for liga in pop_ligos:
    ...
    # trūkstamas dataframe vertes užpildome datomis ir nuliais ties jomis
...
# viso laikotarpio vienos ligos užsikrėtimų istorija vienerių metų intervalais
...
# viso laikotarpio dataframe suskaidome į mažesnius kiekvieniems metams
# ir juos kaip stulpelius pridedame prie naujo dataframe
...
# viso laikotarpio vienos ligos užsikrėtimų istorijos pavaizdavimas
